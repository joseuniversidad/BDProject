...
// 🔹 Obtener las tareas del profesor
$sql_tareas = "SELECT ID_TAREA, TITULO FROM TAREAS WHERE ID_PROF = :id_prof";
...
<body class="bg-gray-100 text-gray-800">
    ...
    <div class="p-8">
        ...
        while ($tarea = oci_fetch_assoc($stmt_tareas)) {
            ...
            // 🔹 Consultar entregas de esta tarea
            $sql_entregas = "
                SELECT ET.ID_ENT, S.NOMBRE, S.APELLIDOS, S.EMAIL, ET.FECHA_ENTREGA, ET.RUTA_ARCHIVO, ET.CALIFICACION
            ...
            while ($entrega = oci_fetch_assoc($stmt_entregas)) {
                ...
                $nota = $entrega['CALIFICACION'] ? htmlspecialchars($entrega['CALIFICACION']) : "—";
        ...
        if (!$tiene_tareas) {
            echo "<p class='text-gray-500 italic'>No has publicado tareas todavía.</p>";
        }
